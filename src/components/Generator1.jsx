...
const Generator = () => {
    ...
    return (
        <section id="generator" className={`w-full bg-pink ${layout.sectionReverse}`}>


            {/* border-t-2 border-black bg-pink */}

            <div className={`relative flex-1  ${layout.sectionGen} ${styles.paddingX}  ${styles.flexCenter} transition-transform hover:-translate-x-2 hover:-translate-y-2`}>
                ...
                <div className="relative md:-translate-y-12 ">
                    ...
                    <div class="group absolute block top-[-16px] md:top-[32px] right-[-19px] md:right-[-55px]">
                        <div class="relative flex h-full transform items-end border-2 border-black bg-white ">
                                <h2 class="m-2 text-lg md:text-6xl font-medium">cema</h2>
                        </div>
                    </div>

                    <div class="group absolute block top-[3rem] md:top-[9rem] right-[-42px] md:right-[-60px]">
                        <div class="relative flex h-full transform items-end border-2 border-black bg-white ">
                                <h2 class="m-2 text-lg md:text-4xl	 font-medium">facts</h2>
                        </div>
                    </div>

                    <div class="group absolute block bottom-[0.5rem] md:bottom-[5.5rem] right-[-27px]">
                        <div class="relative flex h-full transform items-end border-2 border-black bg-white ">
                                <h2 class="m-2 text-lg md:text-5xl	font-medium">finder</h2>
                        </div>
                    </div>
...
{/* min-h-[210px] ss:min-h-[170px] */}
                        <div className={`h-96 p-9 ${styles.flexCenter} mb-10 bg-white border- border-dashed border-black w-full rounded-xl shadow-2xl subpixel-antialiase rounded`}>
